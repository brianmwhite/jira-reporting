...
namespace jr.common.tests.Jira
{
    public class JiraApiTests
    {
        ...
        public void ConvertSecondsToHoursTest()
        {
            ...
            double actualHours = JiraServices.ConvertSecondsToHours(18900);
        ...
        public void ConvertSecondsToHoursZeroTest()
        {
            ...
            double actualHours = JiraServices.ConvertSecondsToHours(0);
            Assert.Equal(expectedHours, actualHours);
        }
        ...
        {
            const double expectedHours = 0;
            double actualHours = JiraServices.ConvertSecondsToHours(-1000);
            Assert.Equal(expectedHours, actualHours);
        }
